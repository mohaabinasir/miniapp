...
export default function Home() {
   ...
   const setAm = (rr: boolean | number = 1000) => {
    ...
    return(<div className="w-screen h-screen text-white flex flex-col" style={{
        ...
        {(mainBtn.is_visible || secBtn.is_visible) && <div className={`w-full bg-black py-2 px-3 sticky bottom-0 left-0 flex justify-center gap-2 flex-1 ${['top', 'bottom'].includes(secBtn.position) ? 'flex-col' : ''}`}>
